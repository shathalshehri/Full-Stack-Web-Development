...
<div id="info">
  ...
  <div id="F">  <br> The Type of your Room : <?php echo $_SESSION['typeroom'] ;?></div>
  <div id="F">  <br> The days you choose : <?php echo $_SESSION['night']; ?></div>
  <div id="F">  <br> Your Price  : <?php echo $_SESSION['price']; ?></div>
  <br><br><br>
...
<button type="submit" name="Cancel" value="Cancel"> Cancel  </submit>
 ...
 if(isset($_POST['submit'])){
   echo '<meta http-equiv="refresh" content="1; URL=payp.php" />';
 }
 if(isset($_POST['Cancel'])){
   echo '<meta http-equiv="refresh" content="1; URL=del.php" />';
 }
 ?>
</div>
